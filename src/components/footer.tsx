  ...
  return (
    <footer className="footer-gradient text-black py-16 px-4 relative overflow-hidden border-t border-gray-200">
      <div className="max-w-6xl mx-auto flex flex-col items-center text-center z-10 relative">
        ...
        {/* Brand/Name */}
        <h1 className="text-4xl md:text-5xl font-bold mb-4 tracking-tight text-[#094293]">
          Rod Garcés
        </h1>
        ...
        <div className="flex gap-6 mb-8">
           <a href="https://www.facebook.com/profile.php?id=100046503616035" aria-label="Facebook" className="social-icon-hover text-black hover:text-blue-600">
             <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M18 2h-3a5 5 0 0 0-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 0 1 1-1h3z"></path></svg>
           </a>
           <a href="https://www.instagram.com/rod.garces?igsh=MXUwZjMwMnV5dTVxdw%3D%3D&utm_source=qr" aria-label="Instagram" className="social-icon-hover text-black hover:text-blue-600">
             <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect x="2" y="2" width="20" height="20" rx="5" ry="5"></rect><path d="M16 11.37A4 4 0 1 1 12.63 8 4 4 0 0 1 16 11.37z"></path><line x1="17.5" y1="6.5" x2="17.51" y2="6.5"></line></svg>
           </a>
           <a href="https://www.tiktok.com/@rod.garces" aria-label="TikTok" className="social-icon-hover text-black hover:text-blue-600">
