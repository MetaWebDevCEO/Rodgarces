      ...
      <div className="max-w-7xl mx-auto w-full">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-start">
          ...
          <div className="flex flex-col">
            <h2 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-gray-900 leading-tight uppercase tracking-tight fade-in-up">
          ...
          <div className="flex flex-col space-y-8 text-lg text-gray-700 leading-relaxed fade-in-up delay-200">
            ...
            <ul className="space-y-4 list-none">
              <li className="flex items-start fade-in-up delay-300">
                ...
                <span>
                  <strong className="text-gray-900">Liderazgo:</strong> instituciones y jóvenes que buscan propósito y dirección.
                </span>
              </li>
              <li className="flex items-start fade-in-up delay-400">
                <span className="mr-3 text-gray-900 font-bold">•</span>
                <span>
                  <strong className="text-gray-900">Duelo:</strong> heridas profundas que detienen la vida y el corazón.
                </span>
              </li>
              <li className="flex items-start fade-in-up delay-500">
                <span className="mr-3 text-gray-900 font-bold">•</span>
                <span>
                  <strong className="text-gray-900">Crianza:</strong> padres que desean hacerlo bien, pero no siempre encuentran el camino.
                </span>
              </li>
            </ul>
